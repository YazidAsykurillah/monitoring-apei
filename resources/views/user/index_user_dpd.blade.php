...
@section('page_header')
  <h1>
    Administrator DPD
    <small>List Administrator DPD</small>
  </h1>
@endsection
    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">List Administrator DPD</h3>
              <a href="{{ url('user-dpd/create') }}" class="btn btn-primary pull-right">Add New</a>
            </div><!-- /.box-header -->
            <div class="box-body">
...
@section('additional_scripts')
  ...
  <script type="text/javascript">
    var tableUser =  $('#table-user').DataTable({
      ...
      serverSide : true,
      ajax : {
        "url" : '{!! route('datatables.getUserDpds') !!}',
      },
      columns :[
