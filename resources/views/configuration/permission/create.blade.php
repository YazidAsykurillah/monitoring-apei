...
@section('breadcrumb')
  <ol class="breadcrumb">
    ...
    <li><a href="{{ URL::to('configuration/permission') }}"><i class="fa fa-lock"></i> Permission</a></li>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          {!! Form::open(['url'=>'configuration/permission/store','role'=>'form','class'=>'form-horizontal','id'=>'form-create-permission','files'=>true]) !!}
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <a href="{{ url('configuration/permission') }}" class="btn btn-default">
