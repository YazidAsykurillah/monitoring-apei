...
@section('page_header')
  <h1>
    Configuration
    <small>Proposal Perpanjangan</small>
  </h1>
@endsection
...
@section('breadcrumb')
  <ol class="breadcrumb">
    ...
    <li class="active"><i></i> Proposal Perpanjangan</li>
  </ol>
@endsection
    ...
    <div class="col-lg-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Proposal Perpanjangan</h3>
        </div>
        <div class="box-body">
          <p class="alert alert-info">
            <i class="fa fa-info-circle"></i>&nbsp;Check to make file to be required
          </p>
          {!! Form::open(['url'=>'configuration/proposal/extension', 'role'=>'form', 'class'=>'form-horizontal', 'method'=>'post']) !!}
