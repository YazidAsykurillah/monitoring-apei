  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box" style="box-shadow:0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-top:none">
        {!! Form::open(['url'=>'configuration/role/update-permission','role'=>'form','class'=>'form-horizontal','id'=>'form-update-role-permission', 'method'=>'POST']) !!}
