...
@section('page_title')
  Proposal | Berkas Tidak Lengkap
@endsection

@section('page_header')
  <h1>
    Proposal
    <small>Daftar Proposal Status Berkas Tidak Lengkap</small>
  </h1>
@endsection
...
@section('breadcrumb')
  <ol class="breadcrumb">
    ...
    <li class="active"><i></i> Berkas Tidak Lengkap</li>
  </ol>
@endsection
    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Daftar Proposal Status Berkas Tidak Lengkap</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
...
@section('additional_scripts')
  ...
  <script type="text/javascript">
    var tableProposal =  $('#table-proposal').DataTable({
      ...
      serverSide : true,
      ajax : {
        "url" : '{!! route('datatables.getProposals_2') !!}',
      },
      columns :[
