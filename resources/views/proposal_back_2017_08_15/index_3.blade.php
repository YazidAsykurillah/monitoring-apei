...
@section('page_title')
  Proposal | Proses Online DJK
@endsection

@section('page_header')
  <h1>
    Proposal
    <small>Daftar Proposal Status Proses Online DJK</small>
  </h1>
@endsection
...
@section('breadcrumb')
  <ol class="breadcrumb">
    ...
    <li class="active"><i></i> Proses Online DJK</li>
  </ol>
@endsection
    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Daftar Proposal Status Proses Online DJK</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
...
@section('additional_scripts')
  ...
  <script type="text/javascript">
    var tableProposal =  $('#table-proposal').DataTable({
      ...
      serverSide : true,
      ajax : {
        "url" : '{!! route('datatables.getProposals_3') !!}',
      },
      columns :[
